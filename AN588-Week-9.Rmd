...
simple bivariate linear model: Y = βo + β1x + e
multivariate linear model: Y = βo + β1x1 + β2x2 +...+ e
...
Second, looking at summary() we see that the β coefficient for each of our predictor variables (including X3) is significant. That is, each predictor is significant even when the effects of the other predictor variables are held constant. Recall that in the simple linear regression, the β
 coefficient for X3
 was not significant.
