...
plot(m)
```
* These plots will also label outliers
...
Other common numerical transformations that are often useful for changing a variable’s distribution to more closely approximate the normal.

* logX y = a + b ln(x)
* LogY y = exp(a + bx)
* asymptotic y = ax / (a + bx)
* reciprocal y = a + b/x
* power law y = a x^b
